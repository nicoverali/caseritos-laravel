            ...
            <div class="sm:ml-16 w-full pb-16 pt-40 sm:pt-8 text-left sm:text-left">
                <form class="w-full" action="#" method="post">
                    ...
                    <div>
                        ...
                        <x-input id="name" class="w-full sm:w-3/4" type="text" name="name" required autofocus/>
                    </div>
                    <div class="mt-6">
                        <x-label for="email" :value="__('client.email')"/>
                        <x-input id="email" class="w-full sm:w-3/4" type="text" name="email" required autofocus/>
                    </div>
